<template>
          ...
          <div id="instructionsList">
            ...
            >
              ...
              <FloatLabel variant="on" style="width: 100%">
                ...
                />
                <label for="'instruction-text-' + index"
                  >Instruction (eg. Preheat oven to 350 degrees)</label
                >
              </FloatLabel>
  ...
  <div id="infoBox" class="info-box">
    ...
    <p id="infoText">
      <strong
        >"Please extract the ingredients and instructions (if in english or with
        imperial measurements please translate to swedish and convert to metric)
        from this recipe and return them as a JSON object with the following
        format:<br />
        {<br />
        title: string,<br />
