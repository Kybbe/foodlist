<template>
  ...
  <ol class="recipe">
    <li v-for="instruction in recipe" :key="instruction.id">
      <input
        type="checkbox"
        :name="instruction.id"
        :id="instruction.id"
    ...
    return {
      recipe: [
        ...
        },
        {
          id: 1,
          checked: false,
          text: "Stek löken i smöret i en stekpanna eller kastrull.",
        },
        {
          id: 2,
          checked: false,
          text: "Sänk värmen och blanda i grädden och majsstärkelsen utrörd i mjölken. Koka upp under upprörning. Rör i skinkan och osten och låt allt bli varmt. Smaka av med salt och peppar.",
        },
        { id: 3, checked: false, text: "Skär tomaterna och hacka gräslöken." },
        {
          id: 4,
          checked: false,
